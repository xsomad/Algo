    ...
    <h1 class="h3 mb-4 text-primary"><?= $title; ?></h1>
 		...
 		<div class="card">
		  <div class="card-header">
		  	<a class="btn btn btn-outline-success" href="" data-toggle="modal" data-target="#newAnggotaModal">Tambah</a>
		  	
		    
		  </div>
		  <div class="card-body">
		    <div class="table-responsive">
                  <table id="empTable" class="table table-bordeless table-hover" width="100%"cellspacing="0">
