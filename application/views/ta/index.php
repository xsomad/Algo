    ...
    <h1 id="h1" class="h3 mb-4 text-primary"><?= $title; ?></h1>
 		...
 		<div class="card">
		  <div class="card-header">
		  	<a class="btn btn btn-outline-success" href="" data-toggle="modal" data-target="#newTAModal">Tambah</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-danger" id="newMenuModalLabel">Add Tahun Akademik</h5>
